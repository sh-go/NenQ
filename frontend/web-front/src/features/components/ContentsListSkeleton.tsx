...
export default function ContentsListSkeleton(): React.JSX.Element {
	return (
		<div className="mb-20 animate-pulse overflow-hidden shadow-md dark:border-gray-700">
					...
					{Array.from({ length: 3 }).map((_, i) => (
						...
						>
							<td className="px-2 py-4 align-middle">
								<div className="mx-auto h-4 w-24 rounded bg-gray-300 dark:bg-gray-600" />
							</td>
							<td className="p-4 align-middle">
								<div className="mx-auto h-4 w-8 rounded bg-gray-300 dark:bg-gray-600" />
							</td>
							<td className="p-4 align-middle">
								<div className="mx-auto h-4 w-8 rounded bg-gray-300 dark:bg-gray-600" />
							</td>
							<td className="p-4 align-middle">
								<div className="mx-auto h-4 w-16 rounded bg-gray-300 dark:bg-gray-600" />
							</td>
