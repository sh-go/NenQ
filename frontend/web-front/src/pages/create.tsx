											...
											<Controller
												...
												render={({ field: { onChange, value, name } }) => (
													<Datepicker
														...
														required={true}
														startWeekOn="mon"
														inputClassName="min-w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 dark:border-gray-600 dark:text-white dark:bg-gray-700 dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500 sm:text-sm"
													/>
												)}
											/>
										</div>
